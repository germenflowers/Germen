...
?>
    <div class="promo-instagram__wrapper">
        <div class="content__container">
            <div class="head-h2 promo-instagram__title">Инстаграм <a class="promo-instagram__title__link" href="https://www.instagram.com/<?=$posts['username']?>/" target="_blank"> @<?=$posts['username']?></a></div>
        </div>
