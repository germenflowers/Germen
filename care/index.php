...
?>
<div class="content content--main content--yellow">
  <div class="care">
    <div class="care__inner">
      ...
      <div class="care__tabs js-tabs" id="care-tabs">
        <div class="care__tabs-header js-tabs__header">
          <li class="care__tabs-item"><a class="care__tabs-link js-tabs__title" href="">Уход&nbsp;за&nbsp;букетом</a></li>
          <li class="care__tabs-item"><a class="care__tabs-link js-tabs__title" href="">за&nbsp;подпиской</a></li>
          <li class="care__tabs-item"><a class="care__tabs-link js-tabs__title" href="">за&nbsp;набором</a></li>
        </div>
        ...
        <div class="care__tabs-content js-tabs__content"><span>2</span>
          <div class="care__list">
            <div class="care__list-item">
              <div class="care__list-title"><svg width="24" height="22" aria-hidden="true">
                  <use xlink:href="<?=SITE_TEMPLATE_PATH?>/img/sprites/sprite.svg#care-1"></use>
        ...
        <div class="care__tabs-content js-tabs__content"><span>3</span>
          <div class="care__list">
            <div class="care__list-item">
              <div class="care__list-title"><svg width="24" height="22" aria-hidden="true">
                  <use xlink:href="<?=SITE_TEMPLATE_PATH?>/img/sprites/sprite.svg#care-1"></use>
  ...
  <div class="first-order">
    <h2 class="first-order__title">Хотите заказать цветы? <br>У нас есть скидка на первый заказ</h2>
      <div class="first-order__links"><a class="first-order__link" href="#">Перейти в каталог</a><a class="first-order__link" href="#">Написать в чат</a></div>
