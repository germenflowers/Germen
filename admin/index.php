    ...
    <div class="order-cover">
        <div class="order-summary">
            ...
            <div class="order-summary__bottom">
                <div class="order-summary__comment">Погрейте, пожалуйста, круассан и поставьте напитки в капхолдер 🙏
                </div>
            ...
            <div class="order-item">
                ...
                <div class="order-item__info">
                    ...
                    <div class="order-item__block">
                        ...
                        <div class="order-item__block-text">Цветы для моего руководителя, наставника, учителя, примера и
                            доброго человека. С днём рождения Ирина Александровна!!! от Рубена.
                        </div>
                    </div>
                </div>
            </div>
